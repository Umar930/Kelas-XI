    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="p-6 border-b border-gray-100">
                <h3 class="text-lg font-semibold text-gray-800">Form Tambah Jadwal</h3>
            </div>
            <form action="{{ route('admin.jadwals.store') }}" method="POST" class="p-6">
                @csrf
                <div class="mb-6">
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="time" name="jam_mulai" value="{{ old('jam_mulai') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 @error('jam_mulai') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_selesai" value="{{ old('jam_selesai') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 @error('jam_selesai') border-red-500 @enderror">
